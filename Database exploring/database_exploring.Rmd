...
```{r}
# TODO: Correo a Profa. Nayeli para solicitar zoom
# 1. Map Gene Symbols and generate the database
# 2. Combat
# 3. Visualization
```
...
write_csv(full_output, path="C:/Users/victo/OneDrive/Documentos/TNBC_research/Database exploring/DB compressed files/GSE575678/GSE575678_clean_with_IDs_only.csv")
```
