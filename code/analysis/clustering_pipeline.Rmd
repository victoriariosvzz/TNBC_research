...
library(readr)
full_resultsc1 %>%
  write_csv(file="complete_DEGs_results_c1_18_sep_22.csv")

full_resultsc2 %>%
  write_csv(file="complete_DEGs_results_c2_18_sep_22.csv")

full_resultsc3 %>%
  write_csv(file="complete_DEGs_results_c3_18_sep_22.csv")
```
