...
Reading clinical data
```{r}
raw_brca_clin <- read.delim(file = "C:/Users/victo/OneDrive/Documentos/TNBC_research/Database exploring/DB compressed files/Ref 3/Ref3_untar/brca_cptac_2020/data_clinical_sample.txt", sep = "\t", header = T, row.names = 1, as.is = T)
